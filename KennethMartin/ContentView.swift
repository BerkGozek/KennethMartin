        ...
        VStack{
            ZStack{
                ...
                Group{
                    ...
                    }.stroke(Color("#C1E2AC"), style: StrokeStyle(lineWidth: 2.5))
                    
                    Path(){path in
                        path.move(to: CGPoint( x:54.2,y:93.6))//W
                        path.addLine(to: CGPoint(x:64.1,y:84))//Z
                    }.stroke(Color("#F8F9F5"), style: StrokeStyle(lineWidth: 2.5))
                    
                    Path(){path in
                        path.move(to: CGPoint( x:39.7,y:6.3))//M
                        path.addLine(to: CGPoint(x:39.4,y:94.2))//N
                    }.stroke(Color("#73ACBF"), style: StrokeStyle(lineWidth: 2.5))
                ...
                Group{
                    ...
                    Path(){path in
                        ...
                        path.addLine(to: CGPoint(x:92.4,y:41.1))//P
                    }.stroke(Color("#73ACBF"), style: StrokeStyle(lineWidth: 2.5))
                    ...
                    Path(){path in
                        ...
                        path.addLine(to: CGPoint(x:6.4,y:93.5))//B1
                    }.stroke(Color("#EC9B9E"), style: StrokeStyle(lineWidth: 2.5))
